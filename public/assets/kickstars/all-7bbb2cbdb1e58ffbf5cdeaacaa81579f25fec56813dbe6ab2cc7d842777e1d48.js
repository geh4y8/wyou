...
Raphael.fn.pieChart = function (cx, cy, r, values, stroke) {
    ...
    var angle = 90,
        ...
        process = function (j) {
            ...
            if(values[j] == 100) {
                var p = paper.circle(cx, cy, r).attr({fill: "#2b2d3d", stroke: "#2b2d3d", "stroke-width": 0});
            }else{
                if (j == 1) {
                    var p = sector(cx, cy, r, angle, angle + angleplus, {fill: "90-#2b2d3d-#2b2d3d", stroke: stroke, "stroke-width": 0});
                }else{
...
$(function () {
    ...
    $(".sys_circle_progress").each(function () {
        ...
        Raphael($(this).find(".sys_holder_sector")[0], 78, 78).pieChart(39, 39, 39, values, "#2b2d3d");
