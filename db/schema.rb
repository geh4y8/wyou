...
ActiveRecord::Schema.define(version: 20160817052854) do
  ...
  create_table "orders_sizes", force: :cascade do |t|
    t.integer "order_id"
    t.integer "size_id"
    t.integer "product_id"
  end

  add_index "orders_sizes", ["order_id"], name: "index_orders_sizes_on_order_id", using: :btree
  add_index "orders_sizes", ["product_id"], name: "index_orders_sizes_on_product_id", using: :btree
  add_index "orders_sizes", ["size_id"], name: "index_orders_sizes_on_size_id", using: :btree
  ...
  create_table "store_supporters", force: :cascade do |t|
    t.integer "user_id"
    t.integer "campaign_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "managed_account"
    t.string   "managed_name"
    t.string   "managed_email"
    ...
    t.text     "treatment_schedule"
    t.date     "item_needed_by"
    t.string   "normal_size"
    t.boolean  "plus_size"
    t.boolean  "petite_size"
    t.text     "other_notes"
    t.date     "dob"
